...
was ↔ monitoring 통신 계층 — 명령 클라이언트·읽기 전용 조회·app 매핑(V13)·조건부 활성화(monitoring.enabled). 프론트 /v1 컨트롤러·이메일 크론은 후속 — [specs/2026-07-28-monitoring-was-seam-design.md](../superpowers/specs/2026-07-28-monitoring-was-seam-design.md)
