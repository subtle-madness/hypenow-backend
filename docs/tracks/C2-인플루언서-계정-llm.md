...
AccountReport 카피 5종(tagline·traits·요약 3분할 — perf/content/ad, 07-27 개편 V40) — stale+쿨다운 재분석·이력 INSERT. 구 7종 컬럼(summary·trend_note·chart_note·ad_headline·pace_note)은 이력 보존용으로 남되 신규 행은 미기록. 캡션 분류(브랜드·광고·카테고리)는 별도 후속(B4)
