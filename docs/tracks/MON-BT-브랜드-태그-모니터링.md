...
[spec 2026-08-17](../superpowers/specs/archive/2026-08-17-brand-ad-disclosure-design.md) ·
...
집합)로: 전역이면 병렬 브랜드가 서로의 2단계를 "겹침"으로 건너뛴다. Hikari 풀은 기본 10 유지(초안의 20은 실측으로 기각 — 직렬 스윕 중 활성 커넥션 최대 1/10·대기 0), 전역 Hiker
