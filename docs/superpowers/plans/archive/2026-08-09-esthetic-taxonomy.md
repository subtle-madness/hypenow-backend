...
- Modify: `docs/superpowers/specs/archive/2026-08-09-esthetic-taxonomy-design.md` (상태 헤더 전환)
...
`docs/superpowers/specs/archive/2026-08-09-esthetic-taxonomy-design.md` 첫머리:
...
```bash
git add DECISIONS.md docs/superpowers/specs/archive/2026-08-09-esthetic-taxonomy-design.md
...
- Modify: `docs/superpowers/specs/archive/2026-08-09-esthetic-taxonomy-design.md` (§4-2 정정)
...
`docs/superpowers/specs/archive/2026-08-09-esthetic-taxonomy-design.md` §4-2의 문장
