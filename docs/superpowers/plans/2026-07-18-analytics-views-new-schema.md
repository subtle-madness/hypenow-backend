...
--   crawl_run 9990 / influencer 9001~9005 / content 9101~9108
--
-- 시나리오:
--   dummy_a(9001)  뷰티 인플루언서 — r1(9101, 릴스: clips 스냅샷 3 + 타임라인 1 — 핀·최신 메타 검증),
--                  r2(9102, 타임라인 전용 릴스 — 787건 케이스), f1(9103, 피드 — views NULL 규칙),
--                  d1(9104, DISCOVERY 잔재 — 모수 제외), rn(9108, 업로드 1일 전 — 숙성 가드)
--   dummy_b(9002)  뷰티 인플루언서 — r3(9105, 캡션 결측·유료 협찬 true). 프로필 HIKER_MOBILE만(소스 분기 검증)
--   dummy_co(9003) 뷰티 회사 — r4(9106, 모수 제외 검증)
--   dummy_x(9004)  비뷰티 — r5(9107, 모수 제외 검증)
--   dummy_e(9005)  EXCLUDED — 콘텐츠·프로필 없음
...
INSERT INTO influencer(id, username, status, followers, beauty, beauty_company, beauty_judged_at) VALUES
 (9001,'dummy_a' ,'QUALIFIED', 5500, true,  false, timestamptz '2026-06-01 00:00:00+09'),
 (9002,'dummy_b' ,'QUALIFIED',20000, true,  false, timestamptz '2026-06-01 00:00:00+09'),
 (9003,'dummy_co','QUALIFIED', 8000, true,  true,  timestamptz '2026-06-01 00:00:00+09'),
 (9004,'dummy_x' ,'QUALIFIED', 9000, false, false, timestamptz '2026-06-01 00:00:00+09'),
 (9005,'dummy_e' ,'EXCLUDED',  NULL, NULL,  NULL,  NULL);
...
INSERT INTO content(id, short_code, content_type, owner_username, influencer_id, uploaded_at, status, first_seen_at, origin, collect_attempts) VALUES
 (9101,'dummy_r1','REELS','dummy_a' ,9001, timestamptz '2026-06-01 09:00:00+09','PENDING', timestamptz '2026-06-01 12:00:00+09','ENUMERATION',0),
 (9102,'dummy_r2','REELS','dummy_a' ,9001, timestamptz '2026-06-02 09:00:00+09','PENDING', timestamptz '2026-06-02 12:00:00+09','ENUMERATION',0),
 (9103,'dummy_f1','FEED' ,'dummy_a' ,9001, timestamptz '2026-06-03 09:00:00+09','PENDING', timestamptz '2026-06-03 12:00:00+09','ENUMERATION',0),
 (9104,'dummy_d1','FEED' ,'dummy_a' ,9001, timestamptz '2026-06-04 09:00:00+09','PENDING', timestamptz '2026-06-04 12:00:00+09','DISCOVERY'  ,0),
 (9105,'dummy_r3','REELS','dummy_b' ,9002, timestamptz '2026-06-01 10:00:00+09','PENDING', timestamptz '2026-06-01 12:00:00+09','ENUMERATION',0),
 (9106,'dummy_r4','REELS','dummy_co',9003, timestamptz '2026-06-01 10:00:00+09','PENDING', timestamptz '2026-06-01 12:00:00+09','ENUMERATION',0),
 (9107,'dummy_r5','REELS','dummy_x' ,9004, timestamptz '2026-06-01 10:00:00+09','PENDING', timestamptz '2026-06-01 12:00:00+09','ENUMERATION',0),
 (9108,'dummy_rn','REELS','dummy_a' ,9001, now() - interval '1 day','PENDING', now() - interval '1 day','ENUMERATION',0);
...
INSERT INTO raw_profile(influencer_id, crawl_run_id, source, username, followers, payload, captured_at) VALUES
 (9001,9990,'HIKER_MOBILE','dummy_a',5000,
 ...
 (9002,9990,'HIKER_MOBILE','dummy_b',20000,
...
INSERT INTO raw_media_page(influencer_id, crawl_run_id, source, payload, captured_at) VALUES
 (9001,9990,'HIKER_V2_CLIPS','{"response":{"status":"ok","items":[{"media":{"code":"dummy_r1","product_type":"clips","taken_at":1780272000,"like_count":500,"comment_count":50,"play_count":10000,"video_duration":30.5,"is_paid_partnership":false,"caption":{"text":"cap r1"},"image_versions2":{"candidates":[{"url":"https://thumb/r1_v1.jpg"}]}}}]}}'::jsonb, timestamptz '2026-06-02 12:00:00+09'),
 (9001,9990,'HIKER_V2_CLIPS','{"response":{"status":"ok","items":[{"media":{"code":"dummy_r1","product_type":"clips","taken_at":1780272000,"like_count":520,"comment_count":52,"play_count":11000,"video_duration":30.5,"is_paid_partnership":false,"caption":{"text":"cap r1 v2"},"image_versions2":{"candidates":[{"url":"https://thumb/r1_v2.jpg"}]}}}]}}'::jsonb, timestamptz '2026-06-05 12:00:00+09'),
 (9001,9990,'HIKER_V2_CLIPS','{"response":{"status":"ok","items":[{"media":{"code":"dummy_r1","product_type":"clips","taken_at":1780272000,"like_count":530,"comment_count":53,"play_count":12000,"video_duration":30.5,"is_paid_partnership":false,"caption":{"text":"cap r1 v3"},"image_versions2":{"candidates":[{"url":"https://thumb/r1_v3.jpg"}]}}}]}}'::jsonb, timestamptz '2026-06-08 12:00:00+09'),
 (9001,9990,'HIKER_V2_CLIPS','{"response":{"status":"ok","items":[{"media":{"code":"dummy_rn","product_type":"clips","taken_at":1781000000,"like_count":5,"comment_count":1,"ig_play_count":100,"caption":{"text":"cap rn"},"image_versions2":{"candidates":[{"url":"https://thumb/rn_v1.jpg"}]}}}]}}'::jsonb, now()),
 (9002,9990,'HIKER_V2_CLIPS','{"response":{"status":"ok","items":[{"media":{"code":"dummy_r3","product_type":"clips","taken_at":1780275600,"like_count":1000,"comment_count":80,"play_count":40000,"video_duration":15.0,"is_paid_partnership":true,"image_versions2":{"candidates":[{"url":"https://thumb/r3_v1.jpg"}]}}}]}}'::jsonb, timestamptz '2026-06-07 12:00:00+09'),
 (9003,9990,'HIKER_V2_CLIPS','{"response":{"status":"ok","items":[{"media":{"code":"dummy_r4","product_type":"clips","taken_at":1780275600,"like_count":10,"comment_count":1,"play_count":500,"caption":{"text":"cap r4"}}}]}}'::jsonb, timestamptz '2026-06-07 12:00:00+09'),
 (9004,9990,'HIKER_V2_CLIPS','{"response":{"status":"ok","items":[{"media":{"code":"dummy_r5","product_type":"clips","taken_at":1780275600,"like_count":20,"comment_count":2,"play_count":600,"caption":{"text":"cap r5"}}}]}}'::jsonb, timestamptz '2026-06-07 12:00:00+09');

-- 댓글 3건 (9101). V8부터 writer/text/written_at은 실컬럼, like_count만 payload에서 추출.
INSERT INTO raw_comment(content_id, crawl_run_id, source, writer, text, written_at, payload, captured_at) VALUES
 (9101,9990,'LEGACY_ENVELOPE','dummy_fan1','pretty','2026-06-04T09:10:00Z','{"likesCount":7}'::jsonb,  timestamptz '2026-06-04 09:10:00+09'),
 (9101,9990,'LEGACY_ENVELOPE','dummy_fan2','love it',NULL,'{}'::jsonb,                                 timestamptz '2026-06-04 09:11:00+09'),
 (9101,9990,'LEGACY_ENVELOPE','dummy_fan1','where to buy','2026-06-04T09:12:00Z','{"likesCount":2}'::jsonb, timestamptz '2026-06-04 09:12:00+09');

-- 실데이터 격리: 더미 외 raw 원형 제거 (ROLLBACK으로 복구). 실 content·influencer 행은 남지만
-- 원형이 없으면 스냅샷·프로필 조인(INNER)에서 자연 탈락 → 상위 뷰는 더미만 본다.
DELETE FROM raw_comment    WHERE content_id NOT BETWEEN 9101 AND 9108;
DELETE FROM raw_media_page WHERE influencer_id NOT BETWEEN 9001 AND 9005;
DELETE FROM raw_profile    WHERE influencer_id NOT BETWEEN 9001 AND 9005;
```
...
BEGIN
  ...
  ASSERT (SELECT count(*) FROM analytics.v_base_content_snapshot WHERE content_id BETWEEN 9101 AND 9108) = 11,
    'v_base_content_snapshot dummy rows != 11 (r1:4, r2·f1·d1·rn·r3·r4·r5:1)';
  ASSERT (SELECT views FROM analytics.v_base_content_snapshot WHERE content_id = 9103) IS NULL,
  ...
  ASSERT (SELECT likes FROM analytics.v_base_detail WHERE content_id = 9101) = 530,
    'v_base_detail r1 likes != 530 (최신 06-08 스냅샷)';
  ASSERT (SELECT views FROM analytics.v_base_detail WHERE content_id = 9101) = 12000,
    'v_base_detail r1 views != 12000';
  ASSERT (SELECT caption FROM analytics.v_base_detail WHERE content_id = 9101) = 'cap r1 v3',
    'v_base_detail r1 caption != cap r1 v3';
  ASSERT (SELECT thumbnail_url FROM analytics.v_base_detail WHERE content_id = 9101) = 'https://thumb/r1_v3.jpg',
    'v_base_detail r1 thumbnail mismatch';
  ASSERT (SELECT views FROM analytics.v_base_detail WHERE content_id = 9102) = 8000,
