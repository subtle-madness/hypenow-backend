...
> 상태: ✅ 구현됨 · 2026-08-28 구현 완료(feat/hashtag-direct-collection) — 구현 중 변경: 이관분 점진 충전(§5) 폐기→기동 즉시 전량 보강, 태그 자동 시드 생성 권한 was 일원화(monitoring 자가 시드 제거, DECISIONS 2026-08-28 참조)
