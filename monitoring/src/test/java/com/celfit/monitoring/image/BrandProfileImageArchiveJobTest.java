...
class BrandProfileImageArchiveJobTest {
	...
	void 신규_아카이브는_ig_user_id_키로_object_path_source_name_archived_at을_기록한다() {
		seedBrand("17841400000001", "glowdeep_official", "https://cdn.example/v/t51/463_111_n.jpg?oe=7FFFFFFF",
				null, null);
	...
	void source_name이_바뀌지_않으면_재다운로드를_스킵한다() {
		seedBrand("1", "glowdeep_official", "https://cdn.example/v/463_111_n.jpg?oe=7FFFFFFF",
	...
	void 쿼리스트링만_다르고_파일명이_같으면_스킵한다() {
		seedBrand("1", "glowdeep_official", "https://cdn-a.example/v/999_222_n.jpg?oe=old&sig=1",
	...
	void 파일명이_바뀌면_같은_키로_재업로드하고_source_name을_갱신한다() {
		seedBrand("1", "glowdeep_official", "https://cdn.example/v/999_222_n.jpg?oe=old",
				"monitor-brand/1.jpg", "999_222_n.jpg");
		db.update("UPDATE brand_account SET profile_pic_url = ? WHERE ig_user_id = '1'",
