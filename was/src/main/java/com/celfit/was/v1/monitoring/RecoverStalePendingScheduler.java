 ...
 * A-1-2 곁가지 + 트랙 LL §4-3) — 기본 10분 간격. 주간 다이제스트 크론(월요일 09:00 KST,
 * {@link com.celfit.was.monitoring.WeeklyDigestJob})과는 별도 크론이다: 크래시 복구로 지연된 등록은
 * 다음 주까지 기다릴 문제가 아니라 분 단위로 재시도해야 한다(MonitoringConfig의 등록 실행기
